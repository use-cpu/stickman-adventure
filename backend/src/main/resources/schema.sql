-- ============================================================
-- 火柴人探险 - 自动初始化脚本
-- Spring Boot 启动时自动执行,幂等(重复运行不报错)
-- ============================================================
...
-- ============================================================
-- 初始数据(INSERT IGNORE 保证幂等,重复执行不报错)
-- ============================================================
...
-- 普通怪物配置
INSERT IGNORE INTO `monster` (`name`,`type`,`level`,`hp`,`attack`,`defense`,`speed`,`exp_reward`,`gold_reward`,`skill_name`,`skill_damage`,`color`,`icon`) VALUES
...
-- Boss配置
INSERT IGNORE INTO `boss` (`name`,`level`,`hp`,`max_hp`,`attack`,`defense`,`speed`,`exp_reward`,`gold_reward`,`skill_name`,`skill_damage`,`phase2_hp_threshold`,`color`,`icon`) VALUES
...
-- 商店商品
INSERT IGNORE INTO `shop_item` (`name`,`category`,`price`,`icon`,`description`,`stat_type`,`stat_value`,`is_unique`,`sort_order`) VALUES
